...
SELECT
provider_id,
CAST(communication_with_nurses_floor AS decimal(1,0)) AS nurses_floor,
CAST(communication_with_nurses_achievement AS decimal(1,0)) AS nurses_threshold,
CAST(communication_with_nurses_benchmark AS decimal(1,0)) AS nurses_benchmark,
CASE WHEN communication_with_nurses_baseline_rate = "Not Available" THEN 9999
ELSE CAST(communication_with_nurses_baseline_rate AS decimal(1,0)) END AS nurses_baseline,
CASE WHEN communication_with_nurses_performance_rate = "Not Available" THEN 9999
ELSE CAST(communication_with_nurses_performance_rate AS decimal(1,0)) END AS nurses_performance,
...
CAST(communication_with_doctors_floor AS decimal(1,0)) AS doctors_floor,
CAST(communication_with_doctors_achievement AS decimal(1,0)) AS doctors_threshold,
CAST(communication_with_doctors_benchmark AS decimal(1,0)) AS doctors_benchmark,
CASE WHEN communication_with_doctors_baseline_rate = "Not Available" THEN 9999
ELSE CAST(communication_with_doctors_baseline_rate AS decimal(1,0)) END AS doctors_baseline,
CASE WHEN communication_with_doctors_performance_rate = "Not Available" THEN 9999
ELSE CAST(communication_with_doctors_performance_rate AS decimal(1,0)) END AS doctors_performance,
...
CAST(responsiveness_of_hospital_staff_floor AS decimal(1,0)) AS responsiveness_floor,
CAST(responsiveness_of_hospital_staff_achievement_threshold AS decimal(1,0)) AS responsiveness_threshold,
CAST(responsiveness_of_hospital_staff_benchmark AS decimal(1,0)) AS responsiveness_benchmark,
CASE WHEN responsiveness_of_hospital_staff_baseline_rate = "Not Available" THEN 9999
ELSE CAST(responsiveness_of_hospital_staff_baseline_rate AS decimal(1,0)) END AS responsiveness_baseline,
CASE WHEN responsiveness_of_hospital_staff_performance_rate = "Not Available" THEN 9999
ELSE CAST(responsiveness_of_hospital_staff_performance_rate AS decimal(1,0)) END AS responsiveness_performance,
...
CAST(pain_management_floor AS decimal(1,0)) AS pain_floor,
CAST(pain_management_achievement_threshold AS decimal(1,0)) AS pain_threshold,
CAST(pain_management_benchmark AS decimal(1,0)) AS pain_benchmark,
CASE WHEN pain_management_baseline_rate = "Not Available" THEN 9999
ELSE CAST(pain_management_baseline_rate AS decimal(1,0)) END AS pain_baseline,
CASE WHEN pain_management_performance_rate = "Not Available" THEN 9999
ELSE CAST(pain_management_performance_rate AS decimal(1,0)) END AS pain_performance,
...
CAST(communication_about_medicines_floor AS decimal(1,0)) AS medicine_floor,
CAST(communication_about_medicines_achievement_threshold AS decimal(1,0)) AS medicine_threshold,
CAST(communication_about_medicines_benchmark AS decimal(1,0)) AS medicine_benchmark,
CASE WHEN communication_about_medicines_baseline_rate = "Not Available" THEN 9999
ELSE CAST(communication_about_medicines_baseline_rate AS decimal(1,0)) END AS medicine_baseline,
CASE WHEN communication_about_medicines_performance_rate = "Not Available" THEN 9999
ELSE CAST(communication_about_medicines_performance_rate AS decimal(1,0)) END AS medicine_performance,
...
CAST(cleanliness_and_quietness_of_hospital_environment_floor AS decimal(1,0)) AS cleanliness_floor,
CAST(cleanliness_and_quietness_of_hospital_environment_achievement_threshold AS decimal(1,0)) AS cleanliness_threshold,
CAST(cleanliness_and_quietness_of_hospital_environment_benchmark AS decimal(1,0)) AS cleanliness_benchmark,
CASE WHEN cleanliness_and_quietness_of_hospital_environment_baseline_rate = "Not Available" THEN 9999
ELSE CAST(cleanliness_and_quietness_of_hospital_environment_baseline_rate AS decimal(1,0)) END AS cleanliness_baseline,
CASE WHEN cleanliness_and_quietness_of_hospital_environment_performance_rate = "Not Available" THEN 9999
ELSE CAST(cleanliness_and_quietness_of_hospital_environment_performance_rate AS decimal(1,0)) END AS cleanliness_performance,
...
CAST(discharge_information_floor AS decimal(1,0)) AS discharge_floor,
CAST(discharge_information_achievement_threshold AS decimal(1,0)) AS discharge_threshold,
CAST(discharge_information_benchmark AS decimal(1,0)) AS discharge_benchmark,
CASE WHEN discharge_information_baseline_rate = "Not Available" THEN 9999
ELSE CAST(discharge_information_baseline_rate AS decimal(1,0)) END AS discharge_baseline,
CASE WHEN discharge_information_performance_rate = "Not Available" THEN 9999
ELSE CAST(discharge_information_performance_rate AS decimal(1,0)) END AS discharge_performance,
...
CAST(overall_rating_of_hospital_floor AS decimal(1,0)) AS overall_floor,
CAST(overall_rating_of_hospital_achievement_threshold AS decimal(1,0)) AS overall_threshold,
CAST(overall_rating_of_hospital_benchmark AS decimal(1,0)) AS overall_benchmark,
CASE WHEN overall_rating_of_hospital_baseline_rate = "Not Available" THEN 9999
ELSE CAST(overall_rating_of_hospital_baseline_rate AS decimal(1,0)) END AS overall_baseline,
CASE WHEN overall_rating_of_hospital_performance_rate = "Not Available" THEN 9999
ELSE CAST(overall_rating_of_hospital_performance_rate AS decimal(1,0)) END AS overall_performance,
...
ELSE CAST(HCAHPS_base_score as decimal(1,0)) END AS base_score,
CASE WHEN HCAHPS_consistency_score = "Not Available" THEN 9999
ELSE CAST(HCAHPS_consistency_score as decimal(1,0)) END AS consistency_score
